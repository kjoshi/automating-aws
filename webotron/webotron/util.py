...
region_to_endpoint = {
    ...
    "ap-northeast-1": Endpoint( "Asia Pacific (Singapore)", "s3-website-ap-southeast-1.amazonaws.com", "Z3O0J2DXBE1FTB"),
    "ap-southeast-2": Endpoint( "Asia Pacific (Sydney)", "s3-website-ap-southeast-2.amazonaws.com", "Z1WCIGYICN2BYD"),
    "ap-southeast-1": Endpoint( "Asia Pacific (Tokyo)", "s3-website-ap-northeast-1.amazonaws.com", "Z2M4EHUR26P7ZW"),
...
def known_region(region):
    """Returns if this is a known region."""
